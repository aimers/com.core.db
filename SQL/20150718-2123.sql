...
--
-- Host: localhost:8889
-- Generation Time: Jul 18, 2015 at 05:47 PM
...
CREATE TABLE `CHRMT` (
  ...
  `CRTBY` bigint(16) NOT NULL COMMENT 'Created By',
  `CHNBY` bigint(16) DEFAULT NULL COMMENT 'Changed By'
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1 COMMENT='Charactiristics Type Master';
...
(1, 'Facebook', 'URL', 'Facebook', 'Facebook', 'FB', '/images/logo/facebook.png', 1, '2015-07-18 00:00:00', NULL, 1, NULL),
(2, 'Twitter', 'url', 'Twitter', 'Twitter', 'TW', '/images/logo/twitter.png', 1, '2015-07-18 00:00:00', NULL, 1, NULL),
(3, 'Google+', 'url', 'Google+', 'Google+', 'TW', '/images/logo/googleplus.png', 1, '2015-07-18 00:00:00', NULL, 1, NULL),
(4, 'Personal Email', 'email', 'Personal Email', 'Personal Email', 'Email', '/images/logo/email.png', 1, '2015-07-18 00:00:00', NULL, 1, NULL),
(5, 'Business Email', 'email', 'Business Email', 'Business Email', 'B-Email', '/images/logo/email.png', 1, '2015-07-18 00:00:00', NULL, 1, NULL),
(6, 'Landline', 'phone', 'Landline', 'Landline', 'Phone', '/images/logo/phone.png', 1, '2015-07-18 00:00:00', NULL, 1, NULL),
(7, 'Mobile', 'mobile', 'Mobile', 'Mobile', 'Mobile', '/images/logo/mobile.png', 1, '2015-07-18 00:00:00', NULL, 1, NULL),
(8, 'Image', 'img', 'Image', 'Image', 'Image', '/images/img.png', 1, '2015-07-18 00:00:00', NULL, 1, NULL);
...
(3, 'Anesthesiologist', 1, '2015-07-15 00:00:00', 1, NULL, NULL, 1, 1),
...
(12, 'Neonatologist', 1, '2015-07-17 00:00:00', 1, NULL, NULL, 1, 1),
...
CREATE TABLE `IENMP` (
  ...
  `CHNDT` datetime DEFAULT NULL COMMENT 'Changed Date',
  `CHNBY` bigint(16) DEFAULT NULL COMMENT 'Changed By'
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='Intent Entity Mapping Table';
...
--
ALTER TABLE `CHRMT`
  MODIFY `CHRID` int(3) NOT NULL AUTO_INCREMENT COMMENT 'Chr Type ID',AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `IENMP`
  MODIFY `MPNID` bigint(16) NOT NULL AUTO_INCREMENT COMMENT 'Mapping ID',AUTO_INCREMENT=2;
--
